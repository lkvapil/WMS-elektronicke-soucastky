...
\begin{itemize}
  ...
  \item Navržena třívrstvá architektura (React + FastAPI + PostgreSQL).
  \item Datový model s~11 hlavními entitami pokrývající kompletní lifecycle
        součástky v~skladu.
  \item 8 UML/PlantUML diagramů dokumentujících use cases, třídy, ER model,
        sekvenční a aktivitní procesy, komponentovou a deployment architekturu.
